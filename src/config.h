...
#define CONV_OUT_ROWS (MNIST_ROWS - CONV_KERNEL_SIZE + 1)
#define CONV_OUT_COLS (MNIST_COLS - CONV_KERNEL_SIZE + 1)
#define FEATURE_SIZE (CONV_OUT_CHANNELS * CONV_OUT_ROWS * CONV_OUT_COLS)
